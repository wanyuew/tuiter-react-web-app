...
console.log('New ES6 arrow function');
const subtract = (a, b) => {
 return a - b;
}
...
let variableArray = [functionScoped, blockScoped, constant1, numberArray1, stringArray1];
...
const init = () => {
   ...
   const removeClassExample = $("#remove-class-1");
   removeClassExample.removeClass('class-2');
